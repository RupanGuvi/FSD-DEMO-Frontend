    ...
    <div className="container mx-auto mt-8">
      <form onSubmit={handleSubmit}  className="bg-white shadow-md rounded p-8">
        ...
        <label htmlFor="image" className="block mb-2 font-bold">
          ...
          <input type="file" name="image" id="image" placeholder="Upload Your Blog Image" accept="image/*"
          onChange={(e)=>setImage(e.target.files[0])}/>
        </p>
        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold mt-8 py-2 px-4 rounded">Create Blog</button>
      </form>
    </div>
  );
};
